...
%
% EVERY NUMBER was read off this repo and the lessons project on 23 September
...
\hsstat{325}{commits to the lessons project since 10 April}
\end{hsstatrow}
...
\hsprovenance{Counts: \texttt{ls lessons/*/claude\_lessons/*/}, \texttt{SKILL.md} (classic
lessons) and \texttt{git log} in the lessons project, 23 September. Table 2: pull requests \#20
