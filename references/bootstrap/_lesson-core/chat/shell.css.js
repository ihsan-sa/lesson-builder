...
// render inside LessonShell. The other 39 predate it and have none of that
// markup. Both sets inject the STYLES export themselves, so while the two
// designs shared one export this sheet restyled all 39 into a layout they were
// never built for -- their original look was lost, and the lessons are what the
// owner studies from.
//
// So the export is the seam: STYLES in chat/chat.css.js stays the sheet the 41
// lessons import, and SHELL_STYLES here is what LessonShell injects over it.
// A lesson using the shell gets this sheet; a lesson that does not gets the
// original. Neither set needed editing.
//
