...
//
// If you land here outside the lesson-builder pipeline (e.g. to sanity-
// check that the scaffold boots), `npm install` + `npx vite` will serve
// the empty component below so the dev server comes up without import
// errors.
